...
func TestRowsEqual(t *testing.T) {
	...
	tests := []struct {
		...
		{func() CacheRow { b := a; b.Favorite = "Different"; return b }(), false},
		...
		{func() CacheRow { b := a; b.Region = "Different"; return b }(), false},
		{func() CacheRow { b := a; b.Country = "Different"; return b }(), false},
			...
			mockSheet: &mockSheet{
				ExistingRows: map[string]sheets.RowWithIndex{
					"GC12345": {
						Index: 1,
						Row: []interface{}{
							"GC12345", "Old Name", "5", "S27 07.000 E153 39.000", "S27 07.000 E153 39.000",
							"0.50", "2023-01-01", "Traditional", "Regular", "2", "1.5",
							"OldOwner", "Queensland", "Australia", "", "Old Note", "2024-06-01 12:00:00",
						},
					},
				},
			},
			...
			mockSheet: &mockSheet{
				ExistingRows: map[string]sheets.RowWithIndex{
					"GC12345": {
						Index: 1,
						Row: []interface{}{
							"GC12345", "Test Cache", "10", "S27 07.407 E153 39.259", "S27 14.074 E153 45.926",
							"77.60", "2024-07-01", "Traditional", "Regular", "2", "1.5",
							"Owner", "Queensland", "Australia", "Yes", "Old Note", "2025-10-11 05:58:35",
						},
					},
				},
			},
