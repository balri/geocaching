...
func TestRowsEqual(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantIsEqual:   false,
			wantChangeLog: []string{"Name changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.PostedCoords = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Posted Coords changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.CorrectedCoords = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Corrected Coords changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.Distance = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Distance changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.PlacedDate = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Placed Date changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.CacheType = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Type changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.CacheSize = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Size changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.Difficulty = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Difficulty changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.Terrain = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Terrain changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.Owner = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Owner changed from 'Different'"},
		},
		{
			b:             func() CacheRow { b := a; b.Found = "Different"; return b }(),
			wantIsEqual:   false,
			wantChangeLog: []string{"Found changed to 'Yes'"},
		},
		{
